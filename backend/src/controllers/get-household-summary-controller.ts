...
import type { GetHouseholdSummaryService } from '../services/get-household-summary-service.js';
...
export function getHouseholdSummaryController(service: GetHouseholdSummaryService): RequestHandler {
